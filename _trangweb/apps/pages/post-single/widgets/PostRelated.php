...
class PostRelated{
	...
	private static $option=[
		...
		"seeMoreLink"=>"",
		"paginate"=>0,
		"categories"=>[WIDGET_DATA["post"]["parent"]??0],
		"flexImgHeight"=>100,
		"flexImgWidth"=>100,
		"itemImgRadius"=>0,
		"itemDescLeng"=>15,
		...
		"gridColumnAmountLg"=>1,
		"gridColumnAmountMd"=>1,
	...
	public static function show($option){
		...
		$option["seeMoreLink"]=PostsCategories::where("id", WIDGET_DATA["post"]["parent"])->value("link");

		$query=Posts::where([ ["status", "=", "public"] ])->whereNotIn("id", [WIDGET_DATA["post"]["id"]]);
