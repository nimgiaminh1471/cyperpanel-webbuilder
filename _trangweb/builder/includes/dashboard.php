...
function builder_dashboard_widgets_body(){
	if(BUILDER_EXPIRED>0){
		...
		if($expiredDays<60){
			echo '
			<div style="color: red;padding: 10px 0"><i class="fa fa-warning"></i> CẢNH BÁO: Website sẽ bị xóa vĩnh viễn nếu quý khách không gia hạn trước ngày: <b>'.date("d/m/Y", (BUILDER_EXPIRED-(3600*24) ) ).'</b></div>
			';
		}
	}
	...
	echo '
	<script src="/builder/assets/chart/progress.js"></script>
	<link href="/builder/assets/chart/progress.css" rel="stylesheet" />
 ...
 * Ẩn Welcome Panel
 */
if( !function_exists('hide_welcome_panel') ){
...
/*
 * Xóa logo wordpress trên trang quản trị
 */
