...
<div style="color: white; background: skyblue;z-index: 1997;padding: 5vh;font-size: 5vh;width: 100vh" id="image-crop-note">Giữ và kéo chuột để cắt</div>
<div>
	...
	$(document).ready(function(){
		...
		$('#cropbox').Jcrop({
			...
			onChange: function(c){
				...
				$("#image-crop-note").html("Rộng: "+size.w+", Cao: "+size.h+"");  
			},
			onSelect: function(c){
				size = {x:c.x,y:c.y,w:c.w,h:c.h};
